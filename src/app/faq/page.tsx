        ...
        <div className="bg-background rounded-3xl p-6 md:p-8 border border-border/50 shadow-sm">
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-left font-bold text-lg">Are my photos safe on the platform?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed text-[15px]">
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger className="text-left font-bold text-lg">How do I delete my profile?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed text-[15px]">
            ...
            <AccordionItem value="item-6">
              <AccordionTrigger className="text-left font-bold text-lg">How does the AI & Astro matchmaking work?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed text-[15px]">
            ...
            <AccordionItem value="item-7">
              <AccordionTrigger className="text-left font-bold text-lg">Is my contact information visible to everyone?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed text-[15px]">
            ...
            <AccordionItem value="item-8">
              <AccordionTrigger className="text-left font-bold text-lg">Can I search for specific communities or sub-castes?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed text-[15px]">
            ...
            <AccordionItem value="item-9">
              <AccordionTrigger className="text-left font-bold text-lg">How do I report a fake or abusive profile?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed text-[15px]">
                Every profile has a "Report Profile" button. If you encounter inappropriate behavior or suspect a profile is fake, click it immediately. Our trust and safety team will investigate and take swift action.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-10">
              <AccordionTrigger className="text-left font-bold text-lg">What happens if I forget my password?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed text-[15px]">
                You can easily reset it by clicking "Forgot Password" on the login page. We'll send a secure reset link to your registered email or an OTP to your phone number.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
