        ...
        <div className="bg-white dark:bg-[#141414] p-8 sm:p-10 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-white/5">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-[15px] text-muted-foreground font-medium">
              Sign in to <span className="text-primary font-bold">{siteConfig.name}</span>
            </p>
          </div>
            ...
            <form className="space-y-4" action="#" method="POST">
              ...
              <div className="flex items-center justify-between pt-1 px-1">
                <label className="flex items-center gap-3 cursor-pointer group">
                  <div className="relative flex items-center justify-center w-5 h-5 rounded-[6px] border-2 border-gray-300 dark:border-gray-600 group-hover:border-primary transition-colors">
                    <input
                      id="remember-me"
                      name="remember-me"
                      type="checkbox"
                    ...
                    />
                    <div className="w-2.5 h-2.5 rounded-[2px] bg-primary scale-0 peer-checked:scale-100 transition-transform" />
                  </div>
                  <span className="text-[14px] font-semibold text-foreground select-none">
                    Remember me
                  </span>
                </label>

                <a href="#" className="text-[14px] font-bold text-primary hover:text-primary/80 transition-colors">
                  Forgot password?
                </a>
              </div>
