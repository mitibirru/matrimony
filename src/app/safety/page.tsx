    ...
    <div className="flex-1 bg-muted/20 py-16 sm:py-24">
      <div className="container max-w-5xl">
        <div className="text-center mb-16 space-y-4">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-green-500/10 text-green-500 mb-4">
            <ShieldCheck className="h-6 w-6" />
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Stay Safe on {siteConfig.name}</h1>
        ...
        <div className="mt-16 bg-background rounded-3xl p-8 border border-border/50 text-center max-w-3xl mx-auto shadow-sm">
          <h2 className="text-2xl font-bold mb-4">Meeting Offline?</h2>
...
function SafetyCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="bg-background rounded-3xl p-6 border border-border/50 shadow-sm hover:shadow-md transition-shadow">
