...
export default function TermsOfServicePage() {
  return (
    <div className="flex-1 bg-muted/20 py-16 sm:py-24">
      <div className="container max-w-4xl bg-background rounded-3xl p-8 sm:p-12 shadow-sm border border-border/50">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">1. Eligibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">2. Account Responsibilities</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">3. Code of Conduct</h2>
            <p>
