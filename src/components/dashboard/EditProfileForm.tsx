...
// ────── Main Component ──────
export default function EditProfileForm({ profile }: { profile: Record<string, any> }) {
      ...
      <Tabs defaultValue="basic" className="gap-4">
          ...
          <Card className="rounded-2xl shadow-sm">
            ...
            <CardContent className="pt-6 space-y-5">
              ...
              <FieldGroup label="Diet" optional>
                <ChipSelector options={["Vegetarian", "Non-Vegetarian", "Eggetarian", "Vegan"]} value={formData.diet} onSelect={(v) => update("diet", v)} />
              </FieldGroup>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="rounded-2xl shadow-sm">
            ...
            <CardContent className="pt-6 space-y-5">
              <FieldGroup label="Religion">
                <ChipSelector options={["Hindu", "Muslim", "Christian", "Sikh", "Buddhist", "Jain", "Other"]} value={formData.religion} onSelect={(v) => update("religion", v)} />
              </FieldGroup>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <FieldGroup label="Mother Tongue"><Input placeholder="e.g. Telugu" value={formData.motherTongue} onChange={(e) => update("motherTongue", e.target.value)} className={inputCls} /></FieldGroup>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <TabsContent value="family">
          <Card className="rounded-2xl shadow-sm">
            ...
            <CardContent className="pt-6 space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <FieldGroup label="Father's Occupation"><Input value={formData.fatherOccupation} onChange={(e) => update("fatherOccupation", e.target.value)} className={inputCls} /></FieldGroup>
                <FieldGroup label="Mother's Occupation"><Input value={formData.motherOccupation} onChange={(e) => update("motherOccupation", e.target.value)} className={inputCls} /></FieldGroup>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <FieldGroup label="Brothers"><Input type="number" min={0} value={formData.brothers} onChange={(e) => update("brothers", Number(e.target.value))} className={inputCls} /></FieldGroup>
                <FieldGroup label="Married"><Input type="number" min={0} value={formData.brothersMarried} onChange={(e) => update("brothersMarried", Number(e.target.value))} className={inputCls} /></FieldGroup>
                <FieldGroup label="Sisters"><Input type="number" min={0} value={formData.sisters} onChange={(e) => update("sisters", Number(e.target.value))} className={inputCls} /></FieldGroup>
                <FieldGroup label="Married"><Input type="number" min={0} value={formData.sistersMarried} onChange={(e) => update("sistersMarried", Number(e.target.value))} className={inputCls} /></FieldGroup>
              </div>
              ...
              <FieldGroup label="Family Status"><ChipSelector options={["Middle Class", "Upper Middle Class", "Rich", "Affluent"]} value={formData.familyStatus} onSelect={(v) => update("familyStatus", v)} /></FieldGroup>
              <FieldGroup label="Family Values"><ChipSelector options={["Orthodox", "Moderate", "Liberal"]} value={formData.familyValues} onSelect={(v) => update("familyValues", v)} /></FieldGroup>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="rounded-2xl shadow-sm">
            ...
            <CardContent className="pt-6 space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <FieldGroup label="State"><Input placeholder="e.g. Telangana" value={formData.state} onChange={(e) => update("state", e.target.value)} className={inputCls} /></FieldGroup>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <FieldGroup label="Country"><Input value={formData.country} onChange={(e) => update("country", e.target.value)} className={inputCls} /></FieldGroup>
